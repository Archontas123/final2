...
public class AbilityManager {
    ...
    public void update() {
        ...
        if (input.isKeyPressed(KeyEvent.VK_F) && input.isKeyPressed(KeyEvent.VK_1)) {
            useForcePull();
        }
        if (input.isKeyPressed(KeyEvent.VK_F) && input.isKeyPressed(KeyEvent.VK_2)) {
            useForcePush();
        }
        ...
        if (input.isKeyPressed(KeyEvent.VK_F) && input.isKeyPressed(KeyEvent.VK_4)) {
            useForceDash();
        }
        if (input.isKeyPressed(KeyEvent.VK_F) && input.isKeyPressed(KeyEvent.VK_5)) {
            useForceHeal();
        }
        if (input.isKeyPressed(KeyEvent.VK_F) && input.isKeyPressed(KeyEvent.VK_6)) {
            handleForceShield();
        }
